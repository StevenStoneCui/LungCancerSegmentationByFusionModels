...
def file_name(file_dir):   
   ...
   for filename in path_list:
       if 'mat' in filename and '360' in filename:
           if 'ROI' in filename:
...
trainLabelImg = sitk.ReadImage('Train_label_lky_0360.nii', sitk.sitkFloat64)
a = sitk.GetArrayFromImage(trainLabelImg)
cv2.imwrite('360_edged_center.png', 255 * a[:, :, a.shape[2] // 2])
